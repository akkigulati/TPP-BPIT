...
credentialsWillBeReadPromise.then(function (credentials) {
    ...
    let wait = driver.wait(swd.until.elementIsNotVisible(soe), 1500);
    return wait;
}).then(function () {
...
return allmodulespromise;
  ...
  for(i=0;i<questions.length;i++){
   ...
   return questionWillbeClickedPromise
    ...
    let editorWillBeSelectedpromise=driver.findElements(swd.By.css(".tab.bold.editorTab"));
    ...
    //let metad=metadataFile
     ...
     let EditorWillbeClickedPromise=Editors[0].click();
